 ...
 * @property {string} [cwd] - Hexo site root. Defaults to the bundled
 *   fixture at `tests/fixtures/hexo-site/`.
 */
...
/**
 * Run `hexo clean && hexo generate` against the fixture site and return
...
module.exports = { generateSite, ensureFixtureInstalled };
